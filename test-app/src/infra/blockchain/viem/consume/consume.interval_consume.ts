...
import { setCurrentBlockNumberConsume } from "../../../cache/redis/cache.current_block_number_consume";
import { getLatestBlockNumber } from "../../../cache/redis/cache.latest_block_number";
